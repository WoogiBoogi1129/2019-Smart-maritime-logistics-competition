package com.orca.orcagamepad.main;
...
// USB시리얼 통신을 하기위한 코드
import com.orca.orcagamepad.control.GyroControl;
import com.orca.orcagamepad.R;
import com.orca.orcagamepad.driver.UsbSerialDriver;
import com.orca.orcagamepad.driver.UsbSerialPort;
import com.orca.orcagamepad.driver.UsbSerialProber;
        ...
        public void handleMessage(Message msgg) {
            ...
            switch (msgg.what) {
                ...
                case SERVER_UPDATE: {
                    ...
                    switch (cliToSerMsg){
                        case "Port Five": raspiMsg = "L1\n";  shipView.setImageResource(R.drawable.l1); receivedBox.setText(cliToSerMsg); break;
                        case "Port Ten": raspiMsg = "L2\n"; shipView.setImageResource(R.drawable.l2); receivedBox.setText(cliToSerMsg); break;
                        case "Port Fifteen": raspiMsg = "L3\n"; shipView.setImageResource(R.drawable.l3); receivedBox.setText(cliToSerMsg); break;
                        case "Port Twenty": raspiMsg = "L4\n"; shipView.setImageResource(R.drawable.l4); receivedBox.setText(cliToSerMsg); break;
                        case "Port Twenty-Five":  raspiMsg = "L5\n"; shipView.setImageResource(R.drawable.l5); receivedBox.setText(cliToSerMsg); break;
                        case "Port Thirty": raspiMsg = "L6\n"; shipView.setImageResource(R.drawable.l6); receivedBox.setText(cliToSerMsg); break;
                        case "Hard a Port": raspiMsg = "L7\n"; shipView.setImageResource(R.drawable.l7); receivedBox.setText(cliToSerMsg); break;
                        case "Midships": raspiMsg = "HOME\n"; shipView.setImageResource(R.drawable.home); receivedBox.setText(cliToSerMsg); break;
                        case "Starboard Five": raspiMsg = "R1\n"; shipView.setImageResource(R.drawable.r1); receivedBox.setText(cliToSerMsg); break;
                        case "Starboard Ten": raspiMsg = "R2\n"; shipView.setImageResource(R.drawable.r2); receivedBox.setText(cliToSerMsg); break;
                        case "Starboard Fifteen": raspiMsg = "R3\n"; shipView.setImageResource(R.drawable.r3); receivedBox.setText(cliToSerMsg); break;
                        case "Starboard Twenty": raspiMsg = "R4\n"; shipView.setImageResource(R.drawable.r4); receivedBox.setText(cliToSerMsg); break;
                        case "Starboard Twenty-Five": raspiMsg = "R5\n"; shipView.setImageResource(R.drawable.r5); receivedBox.setText(cliToSerMsg); break;
                        case "Starboard Thirty": raspiMsg = "R6\n"; shipView.setImageResource(R.drawable.r6); receivedBox.setText(cliToSerMsg); break;
                        case "Hard a Starboard": raspiMsg = "R7\n";shipView.setImageResource(R.drawable.r7); receivedBox.setText(cliToSerMsg); break;
                        case "Full Ahead": raspiMsg = "F3\n"; receivedBoxSpd.setText(cliToSerMsg); break;
                        case "Half Ahead": raspiMsg = "F2\n"; receivedBoxSpd.setText(cliToSerMsg); break;
                        case "Slow Ahead": raspiMsg = "F1\n"; receivedBoxSpd.setText(cliToSerMsg); break;
                        case "Stop": raspiMsg = "ENGINESTOP\n"; receivedBoxSpd.setText(cliToSerMsg); break;
                        case "Slow Astern": raspiMsg = "B1\n"; receivedBoxSpd.setText(cliToSerMsg); break;
                        case "Half Astern": raspiMsg = "B2\n"; receivedBoxSpd.setText(cliToSerMsg); break;
                        case "EXIT": raspiMsg = "EXIT\n"; receivedBox.setText(cliToSerMsg); receivedBoxSpd.setText(" "); break;
